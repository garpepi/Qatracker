				...
				foreach($contents['table_active'] as $active_record){
					...
					<tr>
					  ...
					  <td>
							...
							<a href="/manageenvironment/revoke/<?php echo $active_record['id'] ; ?>" class='confirmation'>Disable</a>
					  </td>
					</tr>
					<?php
				}
			  ...
			  <?php
				foreach($contents['table_inactive'] as $incactive_record){
					...
					<tr>
					  ...
					  <td>
						<a href="/manageenvironment/reactivate/<?php echo $incactive_record['id'] ; ?>" class='confirmation'>Reactivate</a>
					  </td>
					</tr>
					<?php
				}
